<x-layouts.app title="تسجيل حساب">
    <section class="mx-auto max-w-md rounded-md border border-zinc-200 bg-white p-6 shadow-sm">
        ...
        <form method="POST" action="{{ route('register') }}" class="mt-6 flex flex-col gap-4">
            ...
            <label class="flex flex-col gap-2">
                ...
                <input name="name" value="{{ old('name') }}" required class="rounded-md border border-zinc-300 px-3 py-2 focus:border-teal-700 focus:outline-none">
            ...
            <label class="flex flex-col gap-2">
                ...
                <input type="password" name="password_confirmation" required class="rounded-md border border-zinc-300 px-3 py-2 text-left focus:border-teal-700 focus:outline-none" dir="ltr">
            </label>

            <button class="rounded-md bg-teal-700 px-4 py-3 font-bold text-white hover:bg-teal-800">تسجيل</button>
        </form>
    </section>
</x-layouts.app>
